...
function createPlanetTexture(size = 512) {
  ...
  gradient.addColorStop(0.75, '#cae1b0ff');
...
const ringTexts = [
  'Dunia Akuu',//untuk deskripsi planet layer 1
  "I love you Ayyy",//untuk deskripsi planet layer 2
  "♡Spesial Untuk Si Cantik Ku♡",//untuk deskripsi planet layer 3
  "HeHeHeHe Semangat Selaluuu Sayangg",//untuk deskripsi planet layer 4
